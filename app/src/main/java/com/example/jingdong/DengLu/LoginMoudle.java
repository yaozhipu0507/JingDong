...
public class LoginMoudle implements LoginJieKou.ILoginModel {
    @Override
    public void RequestData(String url, String mobile, String password, final LoginJieKou.OnRequestListener onRequestListener) {
        ...
        Observable getlg = apiServer.getlg("user/login", map);
