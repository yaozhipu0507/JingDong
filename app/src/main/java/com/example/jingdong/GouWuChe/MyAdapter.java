...
public class MyAdapter extends BaseExpandableListAdapter{
    ...
    private List<SecletBean> groupList;
    private List<List<SecletBean.ListBean>> childList;
    public MyAdapter(Context context, List<SecletBean> groupList, List<List<SecletBean.ListBean>> childList) {
    ...
    public View getGroupView(final int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        final SecletBean dataBean = groupList.get(i);
...
//        holder.tv_number.setText(dataBean.getTitle());
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        final SecletBean.ListBean datasBean = childList.get(i).get(i1);
...
//                holder.adv.setNumber(origin);
        ...
        holder.tv_del.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                final List<SecletBean.ListBean> datasBeen = childList.get(i);
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int ii) {
                        SecletBean.ListBean remove = datasBeen.remove(i1);
                        if (datasBeen.size() == 0) {
                            childList.remove(i);
                            groupList.remove(i);
...
//        GoosBean.DataBean dataBean = groupList.get(groupPosition);
        SecletBean dataBean = groupList.get(groupPosition);
    ...
    private void changeChildCbState(int groupPosition, boolean flag) {
        List<SecletBean.ListBean> datasBeen = childList.get(groupPosition);

        for (int i = 0; i < datasBeen.size(); i++) {
            SecletBean.ListBean datasBean = datasBeen.get(i);
    ...
    private boolean isAllGroupCbSelected() {
        for (int i = 0; i < groupList.size(); i++) {
            SecletBean dataBean = groupList.get(i);
    ...
    private PriceAndCountEvent compute() {
        ...
        for (int i = 0; i < childList.size(); i++) {
            List<SecletBean.ListBean> datasBeen = childList.get(i);

            for (int j = 0; j < datasBeen.size(); j++) {
                SecletBean.ListBean datasBean = datasBeen.get(j);
